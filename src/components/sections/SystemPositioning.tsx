...
export function SystemPositioning() {
  return (
    <section className="bg-black py-24 md:py-32 px-4 md:px-6 w-full flex justify-center">
      <div className="bg-[#101010] rounded-3xl p-8 md:p-16 lg:p-24 max-w-6xl w-full flex flex-col items-center text-center gap-12">
        {/* Label */}
        ...
        {/* Heading */}
        <div className="max-w-4xl mx-auto text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-lime leading-[0.95] sm:leading-[0.9]">

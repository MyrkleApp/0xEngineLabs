...
export function Footer() {
  return (
    <div className="bg-black px-4 md:px-6 pb-6 w-full flex justify-center">
      <div className="max-w-7xl w-full">
        <motion.footer
          ...
          className="liquid-glass w-full rounded-3xl p-6 md:p-10 text-white/70 mt-16 md:mt-32"
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 mb-10">
            ...
            <div className="md:col-span-5 flex flex-col items-start">
              ...
              <a
                ...
                className="text-lime hover:text-white transition-colors text-sm font-medium mb-6"
              >
              ...
              >
                Start a Project
                <div className="bg-black rounded-full w-6 h-6 flex items-center justify-center transition-transform group-hover:scale-110">
                  <svg className="text-lime w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8">
              <div>
                <h4 className="text-sm uppercase tracking-wider text-white font-medium mb-4">Engineering</h4>
                <ul className="text-xs space-y-3 flex flex-col">
                  {["Custom Software", "Infrastructure", "API Systems", "Process Automation", "Performance Audits"].map(link => (
                    <a key={link} href="#" className="hover:text-white transition-colors w-fit">{link}</a>
                  ))}
                </ul>
              </div>
              <div>
                <h4 className="text-sm uppercase tracking-wider text-white font-medium mb-4">Company</h4>
                <ul className="text-xs space-y-3 flex flex-col">
                  {[
                    { label: "About 0x", href: "#" },
                    ...
                    <a key={link.label} href={link.href} className="hover:text-white transition-colors w-fit">{link.label}</a>
                  ))}
                </ul>
              </div>
          ...
          <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a
              href="mailto:team@0xenginelabs.org"
              className="text-[10px] uppercase tracking-widest opacity-50 hover:opacity-100 hover:text-lime transition-all"
            >
              team@0xenginelabs.org
            </a>
          </div>

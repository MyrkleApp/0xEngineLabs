Create a Next.js + TypeScript + Tailwind CSS landing page for a creative studio called "Ox Engine Labs". The page has 5 sections: Hero, Capabilities, Proof/System Output, Process, Principles, and Footer. Use framer-motion for animations and lucide-react for icons. The design is dark, moody, and cinematic with a warm cream color palette.

FONTS

Load two Fonts from public/fonts folder, and replace default gesit font, and override others

Cabinet Grotesk (weights: 300, 400, 700, 800) -- used as the global default font
Gambarino (italic only) -- used for italic accent text in the Proof/System section
In index.css, set the global font family:


* { font-family: 'Cabinet Grotesk', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', sans-serif; }
In tailwind.config.js, extend:

colors.primary: #FE5F55 (warm cream, used for all primary text and accents)
fontFamily.serif: ['"Gambarino"', 'serif']
COLOR SYSTEM

Background: black (#000000) globally, #101010 for the Proof/System card, #212121 for Features cards
Primary text color: lime (applied via inline style, slightly different from Tailwind primary)
Tailwind primary: #FE5F55 (used for utility classes like text-primary, text-primary/70)
Gray text: text-gray-400, text-gray-500
Navbar link color: rgba(225, 224, 204, 0.8) with hover: lime
...
Link color: rgba(225, 224, 204, 0.8), hover: lime (inline styles)
...
Giant heading "Ox Engine Labs" using WordsPullUp component:
...
Color: lime
Has a superscript asterisk (*) on the final "a" of "Ox Engine Labs": positioned with absolute top-[0.65em] -right-[0.3em] text-[0.31em]
...
"Ox Engine Labs is a worldwide network of visual artists, filmmakers and storytellers bound not by place, status or labels but by passion and hunger to unlock potential through our unique perspectives."
...
SECTION 2: Proof/System

bg-black, padded section with centered content
Inner card: bg-[#101010], centered text, max-w-6xl
Top: small label "Engine Labs" in text-primary, text-[10px] sm:text-xs
## SECTION 2: SYSTEM POSITIONING
...
- Segment 1 → font-normal (Cabinet Grotesk)
- Segment 2 → italic font-serif (Gambarino italic)
- Segment 3 → font-normal (Cabinet Grotesk)
...
We design and deliver high-performance backend systems, infrastructure layers, and automation pipelines. Every component is built to handle load, reduce latency, and maintain stability under real operating conditions. The focus is predictable behavior in production, not controlled environments.

### Typography
text-[#FE5F55]  
text-xs sm:text-sm md:text-base  

### Animation (Scroll-linked)

- Each character wrapped in AnimatedLetter
...
## SECTION 3: SYSTEM OUTPUT / PROOF

### Header (WordsPullUpMultiStyle)

Line 1:
"Built systems. Verified under load."

Line 2:
"Measured performance. Controlled execution."

- Line 1 → text-lime
- Line 2 → text-gray-500
...
**Body:**  
Service-to-service communication structured for reliability and fault tolerance under concurrent load.
...
### CARD 2 — BACKEND PERFORMANCE (01)

**Title:**  
Backend Optimization

**Checklist:**
- Reduced response latency across endpoints  
- Improved throughput under concurrent requests  
- Optimized query execution and caching layers  
- Stabilized service response under peak load  
...
- Fault isolation and recovery systems  
...
- Reduced manual system dependencies  
- Scheduled execution pipelines  
- Monitoring and failure alerting systems  
...
Card 1 - Video card: Full video background (URL: https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260406_133058_0504132a-0cf3-4450-a370-8ea3b05c95d4.mp4), autoPlay loop muted playsInline, object-cover. Bottom text: "Your creative canvas." in lime.
...
Card 3 - "Smart Critiques." (02): Same layout as Card 2. Icon: https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260405_171741_ed9845ab-f5b2-4018-8ce7-07cc01823522.png&w=1280&q=85. 3 checklist items Proof/System AI analysis, creative notes, tool integrations.

Card 4 - "Immersion Capsule." (03): Same layout. Icon: https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260405_171809_f56666dc-c099-4778-ad82-9ad4f209567b.png&w=1280&q=85. 3 checklist items Proof/System notification silencing, ambient soundscapes, schedule syncing.
